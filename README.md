...
backend, no private data; safe to share.

- **Generated by the app itself.** The System tab's **Export Demo** button
  (and `GET /api/export-demo`) builds it by reusing the live frontend and
